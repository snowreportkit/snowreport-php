...
class ApiImportTest extends TestBase
{
        ...
        $handler = HandlerStack::create(
            new MockHandler([
                new Response(
                    ...
                    file_get_contents(__DIR__.'/data/combined.json')
                ),
            ])
        );

        $this->mountain = Mountain::fromUrl(
            'https://acmeskiresort.com',
            new Client(compact('handler'))
        );
